...
public class Warehouse_Master implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Warehouse_Master.this, new Object[] { e,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_OPENIZ_Warehouse_Master.length) {
					if (length < 1024
							&& commonByteArray_OPENIZ_Warehouse_Master.length == 0) {
						commonByteArray_OPENIZ_Warehouse_Master = new byte[1024];
					} else {
						commonByteArray_OPENIZ_Warehouse_Master = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_OPENIZ_Warehouse_Master, 0,
						length);
				strReturn = new String(commonByteArray_OPENIZ_Warehouse_Master,
				...
				try {
					for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1
						...
						if (row9.pid != null) { //
							...
							strBuffer_tLogRow_1
									.append(String.valueOf(row9.pid));
						...
						if (row9.job != null) { //
							...
							strBuffer_tLogRow_1
									.append(String.valueOf(row9.job));
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_6.add("--context_type " + "dwName" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("dwServer", context.dwServer);
				paraList_tRunJob_6.add("--context_type " + "dwServer" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("dwUser", context.dwUser);
				paraList_tRunJob_6.add("--context_type " + "dwUser" + "="
						+ "id_String");

				parentContextMap_tRunJob_6
						.put("dwPassword", context.dwPassword);
				paraList_tRunJob_6.add("--context_type " + "dwPassword" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("dbName", context.dbName);
				paraList_tRunJob_6.add("--context_type " + "dbName" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("dbServer", context.dbServer);
				paraList_tRunJob_6.add("--context_type " + "dbServer" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("dbUser", context.dbUser);
				paraList_tRunJob_6.add("--context_type " + "dbUser" + "="
						+ "id_String");

				parentContextMap_tRunJob_6
						.put("dbPassword", context.dbPassword);
				paraList_tRunJob_6.add("--context_type " + "dbPassword" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("dbPort", context.dbPort);
				paraList_tRunJob_6.add("--context_type " + "dbPort" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("dwPort", context.dwPort);
				paraList_tRunJob_6.add("--context_type " + "dwPort" + "="
						+ "id_String");

				parentContextMap_tRunJob_6
						.put("dwTemplate", context.dwTemplate);
				paraList_tRunJob_6.add("--context_type " + "dwTemplate" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("dwWorking", context.dwWorking);
				paraList_tRunJob_6.add("--context_type " + "dwWorking" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("auditServer",
						context.auditServer);
				paraList_tRunJob_6.add("--context_type " + "auditServer" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("auditCatalog",
						context.auditCatalog);
				paraList_tRunJob_6.add("--context_type " + "auditCatalog" + "="
						+ "id_String");

				parentContextMap_tRunJob_6.put("auditPassword",
						context.auditPassword);
				paraList_tRunJob_6.add("--context_type " + "auditPassword"
						+ "=" + "id_String");

				parentContextMap_tRunJob_6.put("auditUser", context.auditUser);
				paraList_tRunJob_6.add("--context_type " + "auditUser" + "="
						+ "id_String");
				...
				while (propertyNames_tRunJob_6.hasMoreElements()) {
					...
					if (parametersToEncrypt_tRunJob_6.contains(key_tRunJob_6)
							&& value_tRunJob_6 != null) {
						paraListForLog_tRunJob_6.add("--context_param "
								+ key_tRunJob_6
								+ "="
								+ routines.system.PasswordEncryptUtil
										.encryptPassword(String
												.valueOf(value_tRunJob_6)));
					} else {
						paraListForLog_tRunJob_6.add("--context_param "
								+ key_tRunJob_6 + "=" + value_tRunJob_6);
					}
				...
				System.out
						.println("tRunJob_6 in Warehouse_Master call openiz.warehouse_setup_0_1.Warehouse_Setup with:\n\n"
				...
				for (String[] item_tRunJob_6 : childReturn_tRunJob_6) {
					...
					try {
						...
						resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "",
								Thread.currentThread().getId() + "", "DEBUG",
								"", "Starting Pre-Requisites", "", "");
						tLogCatcher_1.addMessage("tWarn", "tWarn_1", 2,
								"Starting Pre-Requisites", 42);
						tLogCatcher_1Process(globalMap);
					...
					paraList_tRunJob_1.add("--context_type " + "dwName" + "="
							+ "id_String");

					parentContextMap_tRunJob_1
							.put("dwServer", context.dwServer);
					paraList_tRunJob_1.add("--context_type " + "dwServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_1.put("dwUser", context.dwUser);
					paraList_tRunJob_1.add("--context_type " + "dwUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_1.put("dwPassword",
							context.dwPassword);
					paraList_tRunJob_1.add("--context_type " + "dwPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_1.put("dbName", context.dbName);
					paraList_tRunJob_1.add("--context_type " + "dbName" + "="
							+ "id_String");

					parentContextMap_tRunJob_1
							.put("dbServer", context.dbServer);
					paraList_tRunJob_1.add("--context_type " + "dbServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_1.put("dbUser", context.dbUser);
					paraList_tRunJob_1.add("--context_type " + "dbUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_1.put("dbPassword",
							context.dbPassword);
					paraList_tRunJob_1.add("--context_type " + "dbPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_1.put("dbPort", context.dbPort);
					paraList_tRunJob_1.add("--context_type " + "dbPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_1.put("dwPort", context.dwPort);
					paraList_tRunJob_1.add("--context_type " + "dwPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_1.put("dwTemplate",
							context.dwTemplate);
					paraList_tRunJob_1.add("--context_type " + "dwTemplate"
							+ "=" + "id_String");

					parentContextMap_tRunJob_1.put("dwWorking",
							context.dwWorking);
					paraList_tRunJob_1.add("--context_type " + "dwWorking"
							+ "=" + "id_String");

					parentContextMap_tRunJob_1.put("auditServer",
							context.auditServer);
					paraList_tRunJob_1.add("--context_type " + "auditServer"
							+ "=" + "id_String");

					parentContextMap_tRunJob_1.put("auditCatalog",
							context.auditCatalog);
					paraList_tRunJob_1.add("--context_type " + "auditCatalog"
							+ "=" + "id_String");

					parentContextMap_tRunJob_1.put("auditPassword",
							context.auditPassword);
					paraList_tRunJob_1.add("--context_type " + "auditPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_1.put("auditUser",
							context.auditUser);
					paraList_tRunJob_1.add("--context_type " + "auditUser"
							+ "=" + "id_String");
					...
					while (propertyNames_tRunJob_1.hasMoreElements()) {
						...
						if (parametersToEncrypt_tRunJob_1
								.contains(key_tRunJob_1)
								&& value_tRunJob_1 != null) {
							paraListForLog_tRunJob_1.add("--context_param "
									+ key_tRunJob_1
									+ "="
									+ routines.system.PasswordEncryptUtil
											.encryptPassword(String
													.valueOf(value_tRunJob_1)));
						} else {
							paraListForLog_tRunJob_1.add("--context_param "
									+ key_tRunJob_1 + "=" + value_tRunJob_1);
						}
					...
					System.out
							.println("tRunJob_1 in Warehouse_Master call openiz.warehouse_prerun_0_1.Warehouse_PreRun with:\n\n"
					...
					try {
						...
						resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "",
								Thread.currentThread().getId() + "", "DEBUG",
								"", "Starting Patients", "", "");
						tLogCatcher_1.addMessage("tWarn", "tWarn_2", 2,
								"Starting Patients", 42);
						tLogCatcher_1Process(globalMap);
					...
					paraList_tRunJob_2.add("--context_type " + "dwName" + "="
							+ "id_String");

					parentContextMap_tRunJob_2
							.put("dwServer", context.dwServer);
					paraList_tRunJob_2.add("--context_type " + "dwServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_2.put("dwUser", context.dwUser);
					paraList_tRunJob_2.add("--context_type " + "dwUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_2.put("dwPassword",
							context.dwPassword);
					paraList_tRunJob_2.add("--context_type " + "dwPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_2.put("dbName", context.dbName);
					paraList_tRunJob_2.add("--context_type " + "dbName" + "="
							+ "id_String");

					parentContextMap_tRunJob_2
							.put("dbServer", context.dbServer);
					paraList_tRunJob_2.add("--context_type " + "dbServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_2.put("dbUser", context.dbUser);
					paraList_tRunJob_2.add("--context_type " + "dbUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_2.put("dbPassword",
							context.dbPassword);
					paraList_tRunJob_2.add("--context_type " + "dbPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_2.put("dbPort", context.dbPort);
					paraList_tRunJob_2.add("--context_type " + "dbPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_2.put("dwPort", context.dwPort);
					paraList_tRunJob_2.add("--context_type " + "dwPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_2.put("dwTemplate",
							context.dwTemplate);
					paraList_tRunJob_2.add("--context_type " + "dwTemplate"
							+ "=" + "id_String");

					parentContextMap_tRunJob_2.put("dwWorking",
							context.dwWorking);
					paraList_tRunJob_2.add("--context_type " + "dwWorking"
							+ "=" + "id_String");

					parentContextMap_tRunJob_2.put("auditServer",
							context.auditServer);
					paraList_tRunJob_2.add("--context_type " + "auditServer"
							+ "=" + "id_String");

					parentContextMap_tRunJob_2.put("auditCatalog",
							context.auditCatalog);
					paraList_tRunJob_2.add("--context_type " + "auditCatalog"
							+ "=" + "id_String");

					parentContextMap_tRunJob_2.put("auditPassword",
							context.auditPassword);
					paraList_tRunJob_2.add("--context_type " + "auditPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_2.put("auditUser",
							context.auditUser);
					paraList_tRunJob_2.add("--context_type " + "auditUser"
							+ "=" + "id_String");
					...
					while (propertyNames_tRunJob_2.hasMoreElements()) {
						...
						if (parametersToEncrypt_tRunJob_2
								.contains(key_tRunJob_2)
								&& value_tRunJob_2 != null) {
							paraListForLog_tRunJob_2.add("--context_param "
									+ key_tRunJob_2
									+ "="
									+ routines.system.PasswordEncryptUtil
											.encryptPassword(String
													.valueOf(value_tRunJob_2)));
						} else {
							paraListForLog_tRunJob_2.add("--context_param "
									+ key_tRunJob_2 + "=" + value_tRunJob_2);
						}
					...
					System.out
							.println("tRunJob_2 in Warehouse_Master call openiz.warehouse_patients_0_1.Warehouse_Patients with:\n\n"
					...
					try {
						...
						tLogCatcher_1Process(globalMap);
						globalMap
								.put("tWarn_3_WARN_MESSAGES", "Starting Users");
					...
					paraList_tRunJob_5.add("--context_type " + "dwName" + "="
							+ "id_String");

					parentContextMap_tRunJob_5
							.put("dwServer", context.dwServer);
					paraList_tRunJob_5.add("--context_type " + "dwServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_5.put("dwUser", context.dwUser);
					paraList_tRunJob_5.add("--context_type " + "dwUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_5.put("dwPassword",
							context.dwPassword);
					paraList_tRunJob_5.add("--context_type " + "dwPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_5.put("dbName", context.dbName);
					paraList_tRunJob_5.add("--context_type " + "dbName" + "="
							+ "id_String");

					parentContextMap_tRunJob_5
							.put("dbServer", context.dbServer);
					paraList_tRunJob_5.add("--context_type " + "dbServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_5.put("dbUser", context.dbUser);
					paraList_tRunJob_5.add("--context_type " + "dbUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_5.put("dbPassword",
							context.dbPassword);
					paraList_tRunJob_5.add("--context_type " + "dbPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_5.put("dbPort", context.dbPort);
					paraList_tRunJob_5.add("--context_type " + "dbPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_5.put("dwPort", context.dwPort);
					paraList_tRunJob_5.add("--context_type " + "dwPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_5.put("dwTemplate",
							context.dwTemplate);
					paraList_tRunJob_5.add("--context_type " + "dwTemplate"
							+ "=" + "id_String");

					parentContextMap_tRunJob_5.put("dwWorking",
							context.dwWorking);
					paraList_tRunJob_5.add("--context_type " + "dwWorking"
							+ "=" + "id_String");

					parentContextMap_tRunJob_5.put("auditServer",
							context.auditServer);
					paraList_tRunJob_5.add("--context_type " + "auditServer"
							+ "=" + "id_String");

					parentContextMap_tRunJob_5.put("auditCatalog",
							context.auditCatalog);
					paraList_tRunJob_5.add("--context_type " + "auditCatalog"
							+ "=" + "id_String");

					parentContextMap_tRunJob_5.put("auditPassword",
							context.auditPassword);
					paraList_tRunJob_5.add("--context_type " + "auditPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_5.put("auditUser",
							context.auditUser);
					paraList_tRunJob_5.add("--context_type " + "auditUser"
							+ "=" + "id_String");
					...
					while (propertyNames_tRunJob_5.hasMoreElements()) {
						...
						if (parametersToEncrypt_tRunJob_5
								.contains(key_tRunJob_5)
								&& value_tRunJob_5 != null) {
							paraListForLog_tRunJob_5.add("--context_param "
									+ key_tRunJob_5
									+ "="
									+ routines.system.PasswordEncryptUtil
											.encryptPassword(String
													.valueOf(value_tRunJob_5)));
						} else {
							paraListForLog_tRunJob_5.add("--context_param "
									+ key_tRunJob_5 + "=" + value_tRunJob_5);
						}
					...
					System.out
							.println("tRunJob_5 in Warehouse_Master call openiz.warehouse_users_0_1.Warehouse_Users with:\n\n"
					...
					try {
						...
						resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_4", "",
								Thread.currentThread().getId() + "", "DEBUG",
								"", "Starting Materials", "", "");
						tLogCatcher_1.addMessage("tWarn", "tWarn_4", 2,
					...
					paraList_tRunJob_4.add("--context_type " + "dwName" + "="
							+ "id_String");

					parentContextMap_tRunJob_4
							.put("dwServer", context.dwServer);
					paraList_tRunJob_4.add("--context_type " + "dwServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_4.put("dwUser", context.dwUser);
					paraList_tRunJob_4.add("--context_type " + "dwUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_4.put("dwPassword",
							context.dwPassword);
					paraList_tRunJob_4.add("--context_type " + "dwPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_4.put("dbName", context.dbName);
					paraList_tRunJob_4.add("--context_type " + "dbName" + "="
							+ "id_String");

					parentContextMap_tRunJob_4
							.put("dbServer", context.dbServer);
					paraList_tRunJob_4.add("--context_type " + "dbServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_4.put("dbUser", context.dbUser);
					paraList_tRunJob_4.add("--context_type " + "dbUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_4.put("dbPassword",
							context.dbPassword);
					paraList_tRunJob_4.add("--context_type " + "dbPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_4.put("dbPort", context.dbPort);
					paraList_tRunJob_4.add("--context_type " + "dbPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_4.put("dwPort", context.dwPort);
					paraList_tRunJob_4.add("--context_type " + "dwPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_4.put("dwTemplate",
							context.dwTemplate);
					paraList_tRunJob_4.add("--context_type " + "dwTemplate"
							+ "=" + "id_String");

					parentContextMap_tRunJob_4.put("dwWorking",
							context.dwWorking);
					paraList_tRunJob_4.add("--context_type " + "dwWorking"
							+ "=" + "id_String");

					parentContextMap_tRunJob_4.put("auditServer",
							context.auditServer);
					paraList_tRunJob_4.add("--context_type " + "auditServer"
							+ "=" + "id_String");

					parentContextMap_tRunJob_4.put("auditCatalog",
							context.auditCatalog);
					paraList_tRunJob_4.add("--context_type " + "auditCatalog"
							+ "=" + "id_String");

					parentContextMap_tRunJob_4.put("auditPassword",
							context.auditPassword);
					paraList_tRunJob_4.add("--context_type " + "auditPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_4.put("auditUser",
							context.auditUser);
					paraList_tRunJob_4.add("--context_type " + "auditUser"
							+ "=" + "id_String");
					...
					while (propertyNames_tRunJob_4.hasMoreElements()) {
						...
						if (parametersToEncrypt_tRunJob_4
								.contains(key_tRunJob_4)
								&& value_tRunJob_4 != null) {
							paraListForLog_tRunJob_4.add("--context_param "
									+ key_tRunJob_4
									+ "="
									+ routines.system.PasswordEncryptUtil
											.encryptPassword(String
													.valueOf(value_tRunJob_4)));
						} else {
							paraListForLog_tRunJob_4.add("--context_param "
									+ key_tRunJob_4 + "=" + value_tRunJob_4);
						}
					...
					System.out
							.println("tRunJob_4 in Warehouse_Master call openiz.warehouse_stockdata_0_1.Warehouse_StockData with:\n\n"
					...
					try {
						...
						resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_5", "",
								Thread.currentThread().getId() + "", "DEBUG",
								"", "Starting Acts", "", "");
						tLogCatcher_1.addMessage("tWarn", "tWarn_5", 2,
								"Starting Acts", 42);
						tLogCatcher_1Process(globalMap);
					...
					paraList_tRunJob_3.add("--context_type " + "dwName" + "="
							+ "id_String");

					parentContextMap_tRunJob_3
							.put("dwServer", context.dwServer);
					paraList_tRunJob_3.add("--context_type " + "dwServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_3.put("dwUser", context.dwUser);
					paraList_tRunJob_3.add("--context_type " + "dwUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_3.put("dwPassword",
							context.dwPassword);
					paraList_tRunJob_3.add("--context_type " + "dwPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_3.put("dbName", context.dbName);
					paraList_tRunJob_3.add("--context_type " + "dbName" + "="
							+ "id_String");

					parentContextMap_tRunJob_3
							.put("dbServer", context.dbServer);
					paraList_tRunJob_3.add("--context_type " + "dbServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_3.put("dbUser", context.dbUser);
					paraList_tRunJob_3.add("--context_type " + "dbUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_3.put("dbPassword",
							context.dbPassword);
					paraList_tRunJob_3.add("--context_type " + "dbPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_3.put("dbPort", context.dbPort);
					paraList_tRunJob_3.add("--context_type " + "dbPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_3.put("dwPort", context.dwPort);
					paraList_tRunJob_3.add("--context_type " + "dwPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_3.put("dwTemplate",
							context.dwTemplate);
					paraList_tRunJob_3.add("--context_type " + "dwTemplate"
							+ "=" + "id_String");

					parentContextMap_tRunJob_3.put("dwWorking",
							context.dwWorking);
					paraList_tRunJob_3.add("--context_type " + "dwWorking"
							+ "=" + "id_String");

					parentContextMap_tRunJob_3.put("auditServer",
							context.auditServer);
					paraList_tRunJob_3.add("--context_type " + "auditServer"
							+ "=" + "id_String");

					parentContextMap_tRunJob_3.put("auditCatalog",
							context.auditCatalog);
					paraList_tRunJob_3.add("--context_type " + "auditCatalog"
							+ "=" + "id_String");

					parentContextMap_tRunJob_3.put("auditPassword",
							context.auditPassword);
					paraList_tRunJob_3.add("--context_type " + "auditPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_3.put("auditUser",
							context.auditUser);
					paraList_tRunJob_3.add("--context_type " + "auditUser"
							+ "=" + "id_String");
					...
					while (propertyNames_tRunJob_3.hasMoreElements()) {
						...
						if (parametersToEncrypt_tRunJob_3
								.contains(key_tRunJob_3)
								&& value_tRunJob_3 != null) {
							paraListForLog_tRunJob_3.add("--context_param "
									+ key_tRunJob_3
									+ "="
									+ routines.system.PasswordEncryptUtil
											.encryptPassword(String
													.valueOf(value_tRunJob_3)));
						} else {
							paraListForLog_tRunJob_3.add("--context_param "
									+ key_tRunJob_3 + "=" + value_tRunJob_3);
						}
					...
					System.out
							.println("tRunJob_3 in Warehouse_Master call openiz.warehouse_acts_1_0.Warehouse_Acts with:\n\n"
					...
					try {
						...
						tLogCatcher_1.addMessage("tWarn", "tWarn_6", 2,
								"Starting Finalization", 42);
						tLogCatcher_1Process(globalMap);
						...
						logIgnoredError(
								String.format(
										"tWarn_6 - tWarn failed to log message due to internal error: %s",
										e_tWarn_6), e_tWarn_6);
					}
					...
					paraList_tRunJob_7.add("--context_type " + "dwName" + "="
							+ "id_String");

					parentContextMap_tRunJob_7
							.put("dwServer", context.dwServer);
					paraList_tRunJob_7.add("--context_type " + "dwServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_7.put("dwUser", context.dwUser);
					paraList_tRunJob_7.add("--context_type " + "dwUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_7.put("dwPassword",
							context.dwPassword);
					paraList_tRunJob_7.add("--context_type " + "dwPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_7.put("dbName", context.dbName);
					paraList_tRunJob_7.add("--context_type " + "dbName" + "="
							+ "id_String");

					parentContextMap_tRunJob_7
							.put("dbServer", context.dbServer);
					paraList_tRunJob_7.add("--context_type " + "dbServer" + "="
							+ "id_String");

					parentContextMap_tRunJob_7.put("dbUser", context.dbUser);
					paraList_tRunJob_7.add("--context_type " + "dbUser" + "="
							+ "id_String");

					parentContextMap_tRunJob_7.put("dbPassword",
							context.dbPassword);
					paraList_tRunJob_7.add("--context_type " + "dbPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_7.put("dbPort", context.dbPort);
					paraList_tRunJob_7.add("--context_type " + "dbPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_7.put("dwPort", context.dwPort);
					paraList_tRunJob_7.add("--context_type " + "dwPort" + "="
							+ "id_String");

					parentContextMap_tRunJob_7.put("dwTemplate",
							context.dwTemplate);
					paraList_tRunJob_7.add("--context_type " + "dwTemplate"
							+ "=" + "id_String");

					parentContextMap_tRunJob_7.put("dwWorking",
							context.dwWorking);
					paraList_tRunJob_7.add("--context_type " + "dwWorking"
							+ "=" + "id_String");

					parentContextMap_tRunJob_7.put("auditServer",
							context.auditServer);
					paraList_tRunJob_7.add("--context_type " + "auditServer"
							+ "=" + "id_String");

					parentContextMap_tRunJob_7.put("auditCatalog",
							context.auditCatalog);
					paraList_tRunJob_7.add("--context_type " + "auditCatalog"
							+ "=" + "id_String");

					parentContextMap_tRunJob_7.put("auditPassword",
							context.auditPassword);
					paraList_tRunJob_7.add("--context_type " + "auditPassword"
							+ "=" + "id_String");

					parentContextMap_tRunJob_7.put("auditUser",
							context.auditUser);
					paraList_tRunJob_7.add("--context_type " + "auditUser"
							+ "=" + "id_String");
					...
					while (propertyNames_tRunJob_7.hasMoreElements()) {
						...
						if (value_tRunJob_7 != null) {
							paraList_tRunJob_7.add("--context_param "
									+ key_tRunJob_7 + "=" + value_tRunJob_7);
						} else {
							paraList_tRunJob_7
									.add("--context_param "
											+ key_tRunJob_7
						...
						if (parametersToEncrypt_tRunJob_7
								.contains(key_tRunJob_7)
								&& value_tRunJob_7 != null) {
							paraListForLog_tRunJob_7.add("--context_param "
									+ key_tRunJob_7
									+ "="
									+ routines.system.PasswordEncryptUtil
											.encryptPassword(String
													.valueOf(value_tRunJob_7)));
						} else {
							paraListForLog_tRunJob_7.add("--context_param "
									+ key_tRunJob_7 + "=" + value_tRunJob_7);
						}
					...
					System.out
							.println("tRunJob_7 in Warehouse_Master call openiz.warheouse_finalize_0_1.Warheouse_Finalize with:\n\n"
	...
	public String contextStr = "Testing";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Warehouse_Master.class
					.getClassLoader().getResourceAsStream(
							"openiz/warehouse_master_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Warehouse_Master.class
						.getClassLoader()
						.getResourceAsStream(
			...
			context.auditPassword = (String) context
					.getProperty("auditPassword");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("dwPassword")) {
				context.dwPassword = (String) parentContextMap
						.get("dwPassword");
			}
			...
			if (parentContextMap.containsKey("dwTemplate")) {
				context.dwTemplate = (String) parentContextMap
						.get("dwTemplate");
			}
			...
			if (parentContextMap.containsKey("auditServer")) {
				context.auditServer = (String) parentContextMap
						.get("auditServer");
			}
			if (parentContextMap.containsKey("auditCatalog")) {
				context.auditCatalog = (String) parentContextMap
						.get("auditCatalog");
			}
			if (parentContextMap.containsKey("auditPassword")) {
				context.auditPassword = (String) parentContextMap
						.get("auditPassword");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Warehouse_Master");
		}
...
/************************************************************************************************
 * 148238 characters generated by Talend Open Studio for Data Integration on the
 * November 3, 2020 12:14:47 EST PM
 ************************************************************************************************/
